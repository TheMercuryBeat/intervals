...
public class Interval {
    ...
    public boolean intersects(Interval interval) {
        return this.min.isWithin(interval.max.value) && this.max.isWithin(interval.min.value)
               && interval.min.isWithin(this.max.value) && interval.max.isWithin(this.min.value);
    }
